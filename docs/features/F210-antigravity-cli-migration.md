...
| Local `agy 1.1.11` model list adds Gemini 3.6 Flash (High/Medium/Low) selector labels; live `--model "Gemini 3.6 Flash (High)"` invocation verified (exit 0) | `agy models`, captured 2026-08-10 in `docs/features/assets/F210/agy-models-2026-08-10.txt` | gemini35's defaultModel moves to `Gemini 3.6 Flash (High)`; legacy slug maps gain `gemini-3.6-flash` so slug inputs keep resolving (selector-label contract unchanged) |
